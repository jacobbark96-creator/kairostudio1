...
export default function PortfolioPage({ initialProjects = null }: { initialProjects?: any }) {
  ...
  return (
    <>
      ...
      />
      <section className="relative pt-32 sm:pt-56 md:pt-64 pb-16 sm:pb-20 px-4 sm:px-6 lg:px-8 overflow-hidden min-h-[40vh] sm:min-h-[50vh] flex items-center">
        ...
        <div className="max-w-7xl mx-auto w-full relative z-10 mt-4 sm:mt-0">
          <Link
            href="/"
