        ...
        <div className={`mx-auto px-4 sm:px-6 lg:px-8 transition-all duration-300 ${
          ...
          <div className={`transition-all duration-300 ${
            ...
            <div className="hidden md:flex items-center gap-2">
              ...
              <Link
                href="/ai"
                className="px-5 py-2 text-sm font-medium rounded-full text-brand-600 dark:text-brand-400 bg-brand-50 dark:bg-brand-500/10 hover:bg-brand-100 dark:hover:bg-brand-500/20 transition-all duration-300"
              >
                AI
              </Link>
              <Link
      ...
      >
        ...
        >
          ...
          <Link
            href="/ai"
            onClick={() => setMobileMenuOpen(false)}
            className="text-3xl font-display font-bold text-brand-600 dark:text-brand-400 hover:text-brand-700 dark:hover:text-brand-300 transition-colors"
          >
            AI
          </Link>
          <Link
