...
export default function CareersPage() {
  ...
  if (selectedJob) {
    return (
      <>
        ...
        />
        <div className="min-h-screen bg-white dark:bg-[#0a0a0a] pt-20 pb-24 selection:bg-brand-500/30">
  ...
  return (
    <>
      ...
      <div className="min-h-screen pt-32 sm:pt-40 pb-24 px-4 sm:px-6 lg:px-8 relative z-0">
        {/* Background */}
